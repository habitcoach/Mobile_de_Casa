...
namespace Mobile_de_Casa.Areas.Admin.Controllers
{
    ...
    public class SubCategoriesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Mobile.Include(s => s.Category);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var subCategory = await _context.Mobile
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CategoryId")] SubCategory subCategory)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Brand, "Id", "Name", subCategory.CategoryId);
            return View(subCategory);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var subCategory = await _context.Mobile.FindAsync(id);
            if (subCategory == null)
            {
                return NotFound();
            }
        ...
        {
            var subCategory = await _context.Mobile.FindAsync(id);
            _context.Mobile.Remove(subCategory);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        public async Task<IActionResult> GetSubCategory(int id)
        {
            ...
            subCategories = await (from subCategory in _context.Mobile
